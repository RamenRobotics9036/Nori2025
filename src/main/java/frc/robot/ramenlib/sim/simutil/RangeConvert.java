...
/**
 * The RangeConvert class provides functionality to convert between physical arm degrees
 * and simulation degrees, with support for optional inversion and buffer adjustments.
 */
public class RangeConvert {
    ...
    public RangeConvert(
        ...
        if (minPhysicalArmDegrees < 0 || maxPhysicalArmDegrees < 0 || minSimDegrees < 0
            || maxSimDegrees < 0) {
            System.out.println("ERROR: Degrees must be non-negative");
        }
        if (minPhysicalArmDegrees >= 360.0 || maxPhysicalArmDegrees >= 360.0
            || minSimDegrees >= 360.0 || maxSimDegrees >= 360.0) {
            System.out.println("ERROR: Degrees must be less than 360");
        }
        if (minPhysicalArmDegrees >= maxPhysicalArmDegrees) {
            System.out.println(
                "ERROR: m_minPhysicalArmDegrees must be less than m_maxPhysicalArmDegrees");
        }
    ...
    public RangeConvert(
        ...
        this(
            minPhysicalArmDegrees,
            maxPhysicalArmDegrees,
            minSimDegrees,
            maxSimDegrees,
            bufferDegrees,
            false);
    ...
    /**
     * Converts simulation degrees to physical arm degrees.
     *
     * @param simDegrees The degrees in the simulation range.
     * @return The corresponding degrees in the physical arm range.
     */
    ...
    /**
     * Converts physical arm degrees to simulation degrees.
     *
     * @param physicalDegrees The degrees in the physical arm range.
     * @return The corresponding degrees in the simulation range.
     */
    public double physicalToSim(double physicalDegrees) {
        ...
        double result = (physicalDegrees - m_minPhysicalArmDegrees)
            / (m_maxPhysicalArmDegrees - m_minPhysicalArmDegrees)
