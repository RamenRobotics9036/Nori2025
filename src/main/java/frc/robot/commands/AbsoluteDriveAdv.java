...
public class AbsoluteDriveAdv extends Command
{
  ...
  public void execute()
  {
    ...
    translation = SwerveMath.limitVelocity(translation, swerve.getFieldVelocity(), swerve.getPose(),
                                           SwerveConstants.kLoopTime, SwerveConstants.kRobotMass, List.of(SwerveConstants.kChassisMatter),
    ...
    {
      resetHeading = true;
      swerve.drive(translation, (SwerveConstants.kLoopTime * -headingAdjust.getAsDouble()), true);
    } else
    {
